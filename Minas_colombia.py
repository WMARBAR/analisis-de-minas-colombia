...
ax.plot(df_minas_pivot_WEEKS["WEEKS"],df_minas_pivot_WEEKS["#INCIDENTES"], linewidth=2,color='black',marker='o',label='Incidentes totales')
ax.legend(loc='upper left',fontsize=10)
ax.tick_params(axis="y",labelsize=10,colors='black')
ax.tick_params(axis="x",labelsize=10,colors='black')
plt.grid(None)
...
ax=fig.add_subplot()
ax.set_title('%incidentes de minas semanales', fontsize=10, fontweight ="bold")
ax.plot(df_minas_pivot_WEEKS["WEEKS"],df_minas_pivot_WEEKS["P_Incidentes"], linewidth=2,color='green',marker='o',label='Incidentes totales')
ax.legend(loc='upper left',fontsize=10)
ax.tick_params(axis="y",labelsize=10,colors='black')
ax.tick_params(axis="x",labelsize=10,colors='black')
plt.grid(None)
